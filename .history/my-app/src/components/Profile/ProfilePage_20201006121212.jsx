...
<div className="statsdiv">
            <p className="HomeTitleMed">Age</p>
            <p className="HomeTitleMed">Member Since</p>
            <p className="HomeTitleMed"> Hours Logged</p>
            <p className="HomeTitleMed">Checklist Tasks Completed</p>
          </div>
<br></br>
<br></br>
<br></br>
