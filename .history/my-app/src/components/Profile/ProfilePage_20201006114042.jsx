...
<div className="statsdiv">
            <p className="HomeTitleSmall">Age</p>
            <p className="HomeTitleSmall">Member Since</p>
            <p className="HomeTitleSmall"> Hours Logged</p>
            <p className="HomeTitleSmall">Checklist Tasks Completed</p>
          </div>
<br></br>
<br></br>
<br></br>
