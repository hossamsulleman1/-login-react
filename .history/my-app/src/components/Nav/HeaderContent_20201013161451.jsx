...
function NavBar() {
  ...
  return (
    <Flex px={2} color="white" bg="black" alignItems="center">
      ...
      <Link style={navStyle} className="" to="/ChecklistPage">
        Checklist Page
      </Link>
      ...
      <Link style={navStyle} className="" to="/CheckListLandingPage">
       CheckList
      </Link>



      <Link style={navStyle} className="" to="/TrackersLandingPage">
        Trackers
      </Link>
