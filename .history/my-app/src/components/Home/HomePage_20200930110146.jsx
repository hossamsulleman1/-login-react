  ...
  return (
    <div>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={6} sm={6}>
          <div>
            <Heading>Set Up & Track Using</Heading>
          ...
          <Text>
            Tracker: with the abilty to track with semptia allows you to see how
            ooften and for how long this is great for making or breaking habbits
          </Text>

          <Text>
            Quotes: Get a daily slice of your favourite quotes to shape you as a
            person 'you are only the thoughts you keep in mind so be selective
            of your reccuring thoughts'
          </Text>
