            ...
            <Grid item container xs={12} spacing={9}>
              <Grid item xs={4}>
                <div className="speedfloatleft">
                  ...
                  <p>
                    explore a range of innovative ways to capture  your bank account allows you to see what shops you
                    like so why can't you see where you spend your time .
                  </p>
                </div>
              </Grid>
              ...
              <Grid item xs={4}>
                ...
                <p>
                  A collection of comprehensive charts to give meaningful and more statistical
