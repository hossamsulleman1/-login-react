...
<Route path='/CheckListLandingPage' component={CheckListLandingPage}/>
<Route path="/TrackersLandingPage" component={TrackersPage}/>
<Route path='/CheckListLandingPage' component={CheckListPage}/>
